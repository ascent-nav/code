...
class HabitatITMPolicy_Qwen_Gdino_DFine(HabitatMixin, ITMPolicyV2):
    def __init__(
        self,
        *args: Any,
        **kwargs: Any,
        ...
        self._object_detector = GroundingDINOClient_MF(port=int(os.environ.get("GROUNDING_DINO_PORT", "12184")))
