...
class HabitatITMPolicy_Qwen_Gdino_DFine_Abla_No_Multi_Floor(HabitatMixin, ITMPolicyV2):
    def __init__(
        self,
        *args: Any,
        **kwargs: Any,
        ...
        # if self._use_vqa:
        #     self._vqa = BLIP2Client(port=int(os.environ.get("BLIP2_PORT", "13185")))
    ...
    def act(
        ...
        for env in range(self._num_envs):
            ...
            #         self._pitch_angle[env] += self._pitch_angle_offset
            #         pointnav_action = TorchActionIDs_plook.LOOK_UP.to(masks.device)
            if not self._done_initializing[env]:  # Initialize for 12 steps
