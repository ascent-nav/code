...
class HabitatITMPolicy_Qwen(HabitatMixin, ITMPolicyV2):
    def __init__(
        self,
        *args: Any,
        **kwargs: Any,
        ...
        self._llm = Qwen2_5ITMClient(port=int(os.environ.get("QWEN2_5ITMClient", "13181")))
    ...
    def _get_best_frontier_with_llm(
        ...
        # 如果没有，那么开始决策
            ...
            if len(sorted_pts) == 1:
                ...
                elif self.floor_num[env] > 1 and self._num_steps[env] - self.multi_floor_ask_step[env] >= 30: # len(self._object_map_list[env][self._cur_floor_index[env]].this_floor_rooms) >= 5
                    # 加辅助条件，当前层发现大于等于5个房间,并且距离上一次问已经过了30步
            ...
            try:
                ...
                if index == "N/A":
                    ...
                    if reason != "N/A":
                        ...
                        self.vlm_response[env] = response_str
    ...
    def _prepare_multiple_floor_prompt(self, target_object_category, env):
        ...
        for floor in range(total_floors):
            try:
                ...
                floor_description = {
                    ...
                    # "fully explored": str(self._obstacle_map_list[env][floor]._this_floor_explored),
                    "room": rooms_str,
                    "objects": objects_str,
                }
        ...
        example_input = (
            ...
            f'{INDENT_L2}"Floor 2": "Other floor. There are room types: bathroom containing objects: shower, towel",\n'
        ...
        prompt =  "\n".join([
            ...
            "You need to answer the question in the following JSON format:",
            example_input,
            'Example Response:\n{"Index": "3", "Reason": "The bedroom is most likely to be on the Floor 3, and the room types and object types on the Floor 1 and Floor 2 are not directly related to the target object bed."}',
            actual_input
        ])
