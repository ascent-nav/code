...
# from utils.utils_fmm.model import get_grid, ChannelPool
# import utils.utils_fmm.depth_utils as du
from falcon.utils.utils_fmm.model import get_grid, ChannelPool
import falcon.utils.utils_fmm.depth_utils as du
...
class Semantic_Mapping(nn.Module):
    ...
    def __init__(self, agent, max_height=None, min_height=None, num_cats=1):
        ...
        self.screen_h = agent._image_height # config.SIMULATOR.DEPTH_SENSOR.HEIGHT
        self.screen_w = agent._image_width # config.SIMULATOR.DEPTH_SENSOR.WIDTH
        self.agent_height = agent._camera_height *100. # config.SIMULATOR.AGENT_0.HEIGHT*100.
        self.resolution = 5
        self.z_resolution = 5
        self.map_size_cm = agent.map_size_cm
        self.vision_range = 100
        self.dropout = 0.5
        self.fov = agent._camera_fov_ori # config.SIMULATOR.DEPTH_SENSOR.HFOV
        self.du_scale = 1
