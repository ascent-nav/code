...
@dataclass
class TurnRightAction2Config(DiscreteNavigationActionConfig):
    r"""
    In Navigation tasks only, this discrete action will rotate the robot to the right
    by a fixed amount determined by the SimulatorConfig.turn_angle amount.
    """
    type: str = "TurnRightAction2"
...
cs.store(
    package="habitat.task.actions.turn_right_2",
    group="habitat/task/actions",
    name="turn_right_2",
    node=TurnRightAction2Config,
)
cs.store(
