...
output_dir = os.path.join(current_working_directory, "data/datasets/objectnav/hm3d/multi_agent_filtered_v1", split, "content")
output_map = os.path.join(current_working_directory, "data/datasets/objectnav/hm3d/multi_agent_filtered_v1", split, "map")
