...
folder_path = os.path.join(current_working_directory, "data/datasets/objectnav/mp3d/v1", split, "content")
output_dir = os.path.join(current_working_directory, "data/datasets/objectnav/mp3d/multi_agent_filtered_v1", split, "content")
output_map = os.path.join(current_working_directory, "data/datasets/objectnav/mp3d/multi_agent_filtered_v1", split, "map")
scenes_dir = 'data/scene_datasets/'
# scene_dataset_config = "data/scene_datasets/mp3d/mp3d_basis.scene_dataset_config.json"
...
def display_map(output_map, topdown_map, scene_count, scene_id, episode_id, split, 
    ...
    file_name = f"mp3d_scene{str(scene_count)}_{scene_id}_{episode_id}_map.png"
...
for scene_count, json_str in enumerate(os.listdir(folder_path)):
    ...
    for episode_count, episode in enumerate(deserialized["episodes"]):
        ...
        scene_episode_data.append({
            "dataset": "mp3d_multi_agent_objectnav",  # seems wrong
            "split": split,
            "scene": scene_id,
